...
(예|아니오)
 a| 
IP 주소를 스토리지 시스템에 사용할 수 있도록 허용합니다. 이는 SnapVault, SnapMirror 및 NetApp Management Console의 데이터 보호 기능에 적용됩니다. IP 주소를 사용하는 것은 문제를 일으킬 수 있으므로 특정 조건에서만 사용해야 합니다.
