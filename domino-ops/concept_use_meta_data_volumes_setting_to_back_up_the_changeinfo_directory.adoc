...
구성 파일을 생성할 때 changeinfo 볼륨을 백업할 볼륨으로 이미 식별했어야 합니다. 자세한 내용은 link:task_using_the_gui_to_create_a_configuration_file.html["GUI를 사용하여 구성을 생성하는 작업"] 단계를 참조하십시오.
